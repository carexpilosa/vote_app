...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _VotingComponent = __webpack_require__(160);
	
	var _VotingComponent2 = _interopRequireDefault(_VotingComponent);
	...
	var vote = {
	  ...
	  totalVotes: 20,
	  choices: [{ id: 'choice1', title: 'Good', count: 7, percent: 35 }, { id: 'choice2', title: 'Bad', count: 12, percent: 35 }, { id: 'choice3', title: 'Not sure yet', count: 1, percent: 5 }]
	};
	
	_reactDom2.default.render(_react2.default.createElement(
	  _Layout2.default,
	  null,
	  _react2.default.createElement(_VotingComponent2.default, { vote: vote })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ChoiceBar = __webpack_require__(161);
	
	var _ChoiceBar2 = _interopRequireDefault(_ChoiceBar);
	...
	var VotingComponent = function (_React$Component) {
	  _inherits(VotingComponent, _React$Component);
	
	  function VotingComponent() {
	    _classCallCheck(this, VotingComponent);
	
	    return _possibleConstructorReturn(this, (VotingComponent.__proto__ || Object.getPrototypeOf(VotingComponent)).apply(this, arguments));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          vote.choices.map(function (choice) {
	            return _react2.default.createElement(_ChoiceBar2.default, _extends({ key: choice.id }, choice));
	          })
	        )
	      );
	    }
	...
	VotingComponent.propTypes = {
	  vote: _react2.default.PropTypes.object.isRequired
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function ChoiceBar(_ref) {
	  var _ref$title = _ref.title,
	      title = _ref$title === undefined ? 'Yeah' : _ref$title,
	      _ref$count = _ref.count,
	      count = _ref$count === undefined ? 123 : _ref$count,
	      _ref$percent = _ref.percent,
	      percent = _ref$percent === undefined ? 37 : _ref$percent;
